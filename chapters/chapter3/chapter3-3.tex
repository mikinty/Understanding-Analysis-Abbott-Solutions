...
Since $K$ is bounded, it must have an upper and lower bound, which means 
$\sup K$ and $\inf K$ must exist.
}
...
We have reached a contradiction, because we can finitely cover $I_{n} \cap K$ by taking 
\begin{equation*}
  \pa{\bigcup_{i=1}^{n_0-1} I_{i}} \cup O_{\lambda_0}
\end{equation*}
}
}
